    ...
    _write_json(
        {
            ...
            "source_priority": payload.get("source_priority", SourcePriority.SYNTHETIC_REALISTIC.value),
            "note": "Seeded demo run events are temporary scaffold data until a real external trainer submits events.",
        },
