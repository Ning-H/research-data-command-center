...
export default function ResearchProgramsPage() {
  return (
    <LifecyclePage
      ...
      status="This becomes the top-level container for work like improving tool-use reliability, reducing hallucination, or improving harmlessness without over-refusal."
      cards={[
        {
          label: "seed example",
          title: "Improve tool-use reliability",
          body: "Track whether adding high-quality tool-use traces improves agent task success.",
        },
        {
          title: "Hypotheses",
